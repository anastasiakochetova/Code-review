...
## 4. Статистика и корреляции

### 4.1 Корреляции признаков с выживаемостью
...
* Средний тариф: 32.2
* Пропуски в `cabin`: 77.1%
* Пассажиры, не выжившие: 61.6%

### 5.2 Ключевые находки

1. **Пол и класс — ключевые факторы выживания**
2. Женщины выживают чаще мужчин
3. Пассажиры 1-го класса имеют наибольшую выживаемость
4. Молодые пассажиры имеют чуть выше шанс выжить
5. Пропуски в `cabin` сильно влияют на анализ
6. Баланс классов относительно удовлетворительный
